                ...
                <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="flex justify-between items-center h-16">
                        ...
                        <div className="flex space-x-8">
                            ...
                            <Link href="#projects" className="text-gray-600 hover:text-blue-600 font-medium">Projects</Link>
            ...
            <section id="home" className="py-20 px-4 sm:px-6 lg:px-8">
                <div className="max-w-6xl mx-auto text-center">
                    ...
                    <p className="text-xl text-gray-600 mb-8 max-w-3xl mx-auto leading-relaxed">
                        Mobile Developer passionate about creating beautiful, functional apps that solve real-world problems.
                        With 2+ years of experience in React Native, I bring ideas to life on iOS and Android platforms.
                    </p>
                        ...
                        {projects.map((project, index) => (
                            ...
                            >
                                <div className="aspect-video relative">
                                    <Image src={project.image || '/images/placeholder.svg'} alt={project.title} fill className="object-cover" />
                                </div>
                                <CardHeader>
                    ...
                    <div className="grid lg:grid-cols-2 gap-12">
                        ...
                        <div className="space-y-8">
                                ...
                                <CardContent className="p-0 space-y-6">
                                    <div className="flex items-center space-x-4">
                                        ...
                                        <div>
                                            ...
                                            <Link href="mailto:anhtuan03.MDev@gmail.com" className="text-blue-600 hover:underline">
                            ...
                            <Card className="p-8">
                                <CardHeader className="p-0 mb-6">
                                    ...
                                    <CardDescription className="text-gray-600">Follow my work and connect on social platforms</CardDescription>
                                </CardHeader>
                                <CardContent className="p-0">
                                    <div className="flex space-x-4">
                                        <Link href="https://github.com/anhtuanMDev" className="bg-gray-900 text-white p-4 rounded-full hover:bg-gray-800">
                                            <Github className="w-6 h-6"/>
                                        </Link>
                                        <Link href="https://www.linkedin.com/in/tu%E1%BA%A5n-nguy%E1%BB%85n-1ab336294/" className="bg-blue-600 text-white p-4 rounded-full hover:bg-blue-700">
                                            <Linkedin className="w-6 h-6"/>
                                        </Link>
                                        <Link href="mailto:anhtuan03.MDev@gmail.com" className="bg-red-500 text-white p-4 rounded-full hover:bg-red-600">
                        ...
                        <Card className="p-8">
                            <CardHeader className="p-0 mb-6">
                                ...
                                <CardDescription className="text-gray-600">Fill out the form below and I&#39;ll get back to you within 24 hours</CardDescription>
                            </CardHeader>
                            <CardContent className="p-0">
                                <form onSubmit={handleSubmit} className="space-y-6">
                                    ...
                                    <div className="space-y-2">
                                        ...
                                        <Textarea id="message" name="message" value={formData.message} onChange={handleChange} placeholder="Tell me about your project or question..." rows={6} required/>
                                    </div>
            ...
            <footer className="bg-gray-900 text-white py-12 px-4 sm:px-6 lg:px-8">
                <div className="max-w-6xl mx-auto text-center">
                    <div className="flex justify-center space-x-6 mb-8">
                        ...
                        <Link href="https://www.linkedin.com/in/tu%E1%BA%A5n-nguy%E1%BB%85n-1ab336294/" className="text-gray-400 hover:text-white">
                            <Linkedin className="w-6 h-6"/>
                        </Link>
                    </div>
